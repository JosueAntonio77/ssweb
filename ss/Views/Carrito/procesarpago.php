			...
			<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
				...
				?>
					<div id="divMetodoPago" >
						<div id="divCondiciones" class="notblock">
						...
						<div id="optMetodoPago">
							<div class="divmetodpago">
								<br>
								<button type="submit" id="btnComprar" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">Procesar cotización</button>
							</div>
						</div>
					</div>
				<?php } ?>
