 <!-- Modal -->
 <div class="modal fade" id="modalFormSolicitudes" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-xl" >
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form id="formSolicitudes" name="formSolicitudes" class="form-horizontal">
