...
function ftnPersonas() {
    if(document.querySelector('#listPersona')){
        let ajaxUrl = base_url+'/Entregas/getSelectPersonas';
        let request = (window.XMLHttpRequest) ? 
                    new XMLHttpRequest() : 
                    new ActiveXObject('Microsoft.XMLHTTP');
        request.open("GET",ajaxUrl,true);
...
function ftnPersonasT() {
    if(document.querySelector('#listPersonaT')){
        let ajaxUrl = base_url+'/Entregas/getSelectPersonasT';
        let request = (window.XMLHttpRequest) ? 
                    new XMLHttpRequest() : 
                    new ActiveXObject('Microsoft.XMLHTTP');
        request.open("GET",ajaxUrl,true);
...
function fntViewInfo(idMantenimiento){
    let request = (window.XMLHttpRequest) ? 
                    new XMLHttpRequest() : 
                    new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl = base_url+'/Entregas/getMantenimiento/'+idMantenimiento;
    request.open("GET",ajaxUrl,true);
    request.send();
    request.onreadystatechange = function(){
        if(request.readyState == 4 && request.status == 200){
        ...
        inputUploadfile.addEventListener('change', function(){
            ...
            if(uploadFoto !=''){
                ...
                if(type != 'image/jpeg' && type != 'image/jpg' && type != 'image/png'){
                    ...
                    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
                    let ajaxUrl = base_url+'/Entregas/setImage'; 
...
function fntDelItem(element){
    ...
    let idMantenimiento = document.querySelector("#idMantenimiento").value;
    let request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
    let ajaxUrl = base_url+'/Entregas/delFile'; 
