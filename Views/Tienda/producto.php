				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<div class="flex-w flex-m p-l-100 p-t-40 respon7">
							...
							onclick="window.open('https://twitter.com/intent/tweet?text=<?= $arrProducto['nombre'] ?>&url=<?= $urlShared; ?>&hashtags=<?= SHAREDHASH; ?>','ventanacompartir','toolbar=0, status=0, width=650, height=450');"
							>
								<i class="fa fa-twitter"></i>
							</a>

							<a href="#" class="fs-14 cl3 hov-cl1 trans-04 lh-10 p-lr-5 p-tb-2 m-r-8 tooltip100" data-tooltip="What'sApp"
							onclick="window.open('https://api.whatsapp.com/send?text=<?= $arrProducto['nombre'].' '.$urlShared ?>','ventanacompartir','toolbar=0, status=0, width=650, height=450');"
							>
