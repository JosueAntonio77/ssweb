<div class="modal" id="exampleModal"  tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Registrar Nueva Reunión</h5>
  ...
  <form name="formEvento" id="formEvento" action="nuevoEvento.php" class="form-horizontal" method="POST">
		<div class="form-group">
			<label for="evento" class="col-sm-12 control-label">Nombre de la Reunión</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" name="evento" id="evento" placeholder="Asunto de la Reunión" required/>
			</div>
		</div>
    <div class="form-group">
      <label for="user1id" class="col-sm-12 control-label">Usuario 1</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" name="user1id" id="user1id" placeholder="Actor en la Reunión" required/>
      </div>
    </div>
    <div class="form-group">
      <label for="user2id" class="col-sm-12 control-label">Usuario 2</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" name="user2id" id="user2id" placeholder="Actor en la Reunión" required/>
      </div>
    </div>
    <div class="form-group">
  ...
  <!--<div class="form-group">
			<label for="notas" class="col-sm-12 control-label">Notas</label>
			<div class="col-lg-12">
				<input type="text" class="form-control" name="notas" id="notas" placeholder="Temas a tocar en la Reunión">
			</div>
	</div>-->
